...
import { GeneraluseinsertPage } from '../generaluseinsert/generaluseinsert';
import { File } from '@ionic-native/file';

@Component({
  selector: 'page-generaluse',
  templateUrl: 'generaluse.html',
})
export class GeneralusePage {
  num: number;
  dates: string;
  ...
  edit(item) {
    ...
    this.navCtrl.push(GeneraluseinsertPage, data);
  }
  delete(item) {
  ...
  insertRent(){
    this.navCtrl.push(GeneraluseinsertPage);
  } 
}
