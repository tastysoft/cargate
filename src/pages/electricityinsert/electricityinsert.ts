...
@Component({
  selector: 'page-electricityinsert',
  templateUrl: 'electricityinsert.html',
})
export class ElectricityinsertPage {
  electricity: string;
  remark: string;
  ...
  save() {
    if ((this.electricity == "" || this.electricity == undefined) && (this.dateOfEvent == "" || this.dateOfEvent == undefined)) {
      this.message('မီတာခနှင့် ရက်စွဲဖြည့်ပါ။');
